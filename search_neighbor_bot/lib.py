...
соседа к себе в квартиру или человека с жильем, который рад разделить оплату за него! Можно найти потенциального соседа, даже если жилья на примете у вас обоих нет: вместе искать квартиру быстрее и проще.

Я работаю по модели Tinder'a 🔥

Для начала ты создаешь свою анкету, после чего тебе открываются анкеты других людей, которые ты можешь \
лайкнуть или пропустить. 

Если с кем-то у тебя случится "match", я отправлю вам контакты друг друга.
...
Если все понятно, то пора создавать анкету!"""
...
help_message = f"<b>Как работает этот бот?</b>\n\nДля начала ты создаешь анкету, указывая критерии для поиска:\n\n"\
                ...
                "заданную, а также все анкеты таких же искателей квартир, как и ты.\n\n" \
               "После ты сможешь посмотреть анкеты других пользователей и как в Tinder`e ставить им лайк или " \
               ...
               "Ты в любое время можешь изменить свою анкету или создать новую."
